...
You can send measurement stream data for your group via our [SDK](/emit-data/sdk) or [API](/emit-data/api).
...
Once you've set up a monitoring stream, you can start sending stream data for your stream via our [SDK](/emit-data/sdk) or [API](/emit-data/api).
...
- **Summary**: Display a summary of your data with a text-based <Translate text="visualization" />
