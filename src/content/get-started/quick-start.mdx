...
Once you've set up a monitoring group, you can start sending stream data for your group via our [SDK](/emit-data/sdk) or [API](/emit-data/api).
...
Learn more about [Charts](/chart-data) and how to create them.
