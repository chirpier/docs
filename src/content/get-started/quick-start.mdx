...
Once the event is public, use the hosted event page directly or embed it with the Chirpier chart clients. See [Public Event Pages](/dashboard-and-embed/public-event-pages) for the sharing flow.
