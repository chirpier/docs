...
The test response returns the synthetic test `alert_id`. Then inspect test delivery history with:
...
The detailed source material still lives in `chirrop-skills`, but `docs` is the canonical public explanation of the workflow.
