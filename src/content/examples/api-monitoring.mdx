...
```go
_ = client.Log(ctx, chirrop.Log{Agent: "api.v1", Event: "api.requests.count", Value: 1,
    Meta: map[string]any{"method": "POST", "path": "/v1/orders"}})

_ = client.Log(ctx, chirrop.Log{Agent: "api.v1", Event: "api.response.duration_ms", Value: 145,
    Meta: map[string]any{"method": "POST", "path": "/v1/orders", "status": 201}})

_ = client.Log(ctx, chirrop.Log{Agent: "api.v1", Event: "api.errors.count", Value: 1,
