...
Chirpier Charts will update in real-time in any modern web browser, immediately as data is emitted to Chirpier. So no need for browser refreshes, or waiting for data warehouse updates.

Chirpier currently supports four real-time chart types:
...
Read more about [Charts](/docs/charts/charts).
...
Read more about [Policies](/docs/monitor/policies).
