...
The [Chirpier SDK for Python](https://github.com/chirpier/chirpier-py) is a simple, lightweight, and efficient SDK to emit event data to Chirpier direct from your Python applications.
