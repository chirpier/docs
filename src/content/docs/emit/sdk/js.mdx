...
The [Chirpier SDK for JavaScript](https://github.com/chirpier/chirpier-js) is a simple, lightweight, and efficient SDK to emit event data to Chirpier direct from your JavaScript applications.
